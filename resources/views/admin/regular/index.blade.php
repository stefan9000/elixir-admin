    ...
    <div class="table-holder" id="root">
        ...
        <table class="table">
            ...
            <tr class="dark-tr" v-for="entry in entries">
                ...
                <td>
                    <h6>Provider</h6>
                    <h5 v-text="entry.provider"></h5>
                </td>
                <td class="action">
                    <a class="ticket" :href="'/_control/regular/' + entry.id + '/tickets'" target="_blank">Tickets</a>
                    <a class="view" :href="'/_control/regular/' + entry.id">View</a>
                </td>
            </tr>
            </tbody>
        </table>
...
@section('scripts')
    <script type="text/javascript">
        const app =new Vue({
            ...
            methods: {
                fetchData(page = 1) {
                    this.$http.get('{{ route('api_regular_index') }}', {
                        params: {
                            page: page
                        }
                    })
